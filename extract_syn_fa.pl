...
my $candidate_gene_dir = $ARGV[7]; #Backup_folder: '/mnt/bridgecereal/candidate_dir/Speciesx/';
...
#my $candidate_gene_dir = '/mnt/946c1663-fcbd-4a78-8887-c55f23c5b496/bszhang/Test_Candidate/';


mkdir $candidate_gene_dir.'Candidate_genes/' unless -e $candidate_gene_dir.'Candidate_genes/';
my $gene_dir = $candidate_gene_dir.'Candidate_genes/'.$gene.'/'; # modifify this as the directory you can write into.
