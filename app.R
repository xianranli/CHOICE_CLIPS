...
database_folder <- paste('/home/xianran_li/bridgecereal/','database','/',sep='');
...
#  Species("Wheat","IWGSC",database_folder,gff_folder,script_folder,User_folder), # 'IWGSC' ... defined as default_ref
   Species("Maize","B73",database_folder,gff_folder,script_folder,User_folder,candidate_dir)   # 'B73' ... defined as default_ref
