...
#column(6, align="left", tags$iframe(width="550", height="320", src="http://10.105.85.25/BRIDGEcereal/BRIDGEcereal_Instructions1.pdf")),
#column(6, align="right", tags$iframe(width="550", height="320", src="http://10.105.85.25/BRIDGEcereal/BRIDGEcereal_Instructions2.pdf")),
#column(6, align="left", tags$iframe(width="550", height="320", src="http://10.105.85.25/BRIDGEcereal/BRIDGEcereal_Instructions3.pdf")),
#column(6, align="right", tags$iframe(width="550", height="320", src="http://10.105.85.25/BRIDGEcereal/BRIDGEcereal_Instructions4.pdf")),


#column(12, align="center", tags$iframe(width="1200", height="800", src="http://10.105.85.25/BRIDGEcereal/Demo.mp4", frameborder="0", allowfullscreen=NA)),
