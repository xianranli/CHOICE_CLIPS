...
Species <- function(Speciesx,default_ref,database_folder,gff_folder,script_folder,User_folder){
...
source( paste(script_folder,'BRIDGEcereal_Sub.R',sep=''), local = TRUE)
Pre_run(default_choice,gff_folder,gff_folder_Species,User_folder) ## jobs_folder replaced by Backup_folder; AllGenomes_GeneName removed; gpattern removed
...
####################################################################################################################
####################################################################################################################
Pre_run <- function(default_choice,gff_folder,gff_folder_Species,User_folder) {
